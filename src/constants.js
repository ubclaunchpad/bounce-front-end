export const INVALID_INFO = 'Please make sure your information meets the specified requirements.';
export const USERNAME_OR_EMAIL_TAKEN = 'We\'re sorry; that username or email is already taken';
